...
const Trail = ({handlePrevious,onNext}:{handlePrevious:() => void,onNext:() => void}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.box}>
          <Stack gap="$3">
            <Text style={styles.input}>
              <Image source={require('@/assets/images/check.png')} /> Manage
              bookings
            </Text>
            <Text style={styles.input}>
              <Image source={require('@/assets/images/check.png')} /> Advance
              statistics
            </Text>
            <Text style={styles.input}>
              <Image source={require('@/assets/images/check.png')} /> Scheduling
            </Text>
            <Text style={styles.input}>
              <Image source={require('@/assets/images/check.png')} /> Advertise
              yourself
            </Text>
            <Text style={styles.input}>
              <Image source={require('@/assets/images/check.png')} /> zero
              Commissions
            </Text>
          </Stack>
        </View>
      ...
      <Button onPress={updatePlayer} style={styles.button}>
